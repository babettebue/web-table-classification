...
#df_feat = pd.read_pickle(r'E:\Babette\MasterThesis\Feature_extractor\ResNet_finetuned\All_feature_maps\manual_resnet_finetuned_feature_maps_dataset.pkl')
df_feat = pd.read_pickle(r'manual_resnet_finetuned_feature_maps_dataset.pkl')
...
dump(best_grid, r'heuristic_resnet_finetuned_feature_maps_rf.joblib', protocol=4) 
...
dump(best_grid_vis, r'resnet_finetuned_feature_maps_rf.joblib', protocol=4) 
...
for f in range(0,11):
    print("%d. feature %d (%f)" % (f + 1, indices[f], importances[indices[f]]))
    print(df_test_vis.columns[indices[f]])
