...
df_feat = pd.read_pickle(r'E:\Babette\MasterThesis\Feature_extractor\VGG16_imagenet\manual_vgg16_features_dataset.pkl')
#df_feat = pd.read_pickle(r'manual_vgg16_features_dataset.pkl')
...
#save model
#dump(model, r'E:\Babette\MasterThesis\Feature_extractor\VGG16_imagenet\With_nested_mean_imputation\heuristic_vgg16_rf.joblib') 
#model= load( r'E:\Babette\MasterThesis\Feature_extractor\VGG16_imagenet\With_nested_mean_imputation\heuristic_vgg16_rf.joblib') 

df= pd.DataFrame(data={'id': label_test_id, 'y_pred': y_pred, 'y_test': label_test})
df.to_pickle(r'E:\Babette\MasterThesis\McNemarTest\man_vis_rf.pkl')
# Acurracy0.9363081617086194

#               precision    recall  f1-score   support
#       Layout     0.9435    0.9234    0.9334      1267
#      Genuine     0.9298    0.9483    0.9390      1355

#    micro avg     0.9363    0.9363    0.9363      2622
#    macro avg     0.9367    0.9359    0.9362      2622
# weighted avg     0.9364    0.9363    0.9363      2622
...
len(false)
#np.save(r'E:\Babette\MasterThesis\Feature_extractor\VGG16_imagenet\With_nested_mean_imputation\vgg16_heur_false_id.npy', false)
...
# Acurracy0.9046529366895499

#  [ 117 1238]]

#               precision    recall  f1-score   support

#       Layout     0.9065    0.8950    0.9007      1267
#      Genuine     0.9030    0.9137    0.9083      1355

#    micro avg     0.9047    0.9047    0.9047      2622
#    macro avg     0.9047    0.9043    0.9045      2622
# weighted avg     0.9047    0.9047    0.9046      2622

#save model
#dump(best_grid, r'E:\Babette\MasterThesis\Feature_extractor\VGG16_imagenet\With_nested_mean_imputation\vgg16_rf.joblib') 
#best_grid= load( r'E:\Babette\MasterThesis\Feature_extractor\VGG16_imagenet\With_nested_mean_imputation\vgg16_rf.joblib') 
...
#np.save(r'E:\Babette\MasterThesis\Feature_extractor\VGG16_imagenet\With_nested_mean_imputation\vgg16_false_id.npy', false)
