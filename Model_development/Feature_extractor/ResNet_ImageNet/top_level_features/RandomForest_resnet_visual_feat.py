...
#df_feat = pd.read_pickle(r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\manual_resnet_features_dataset.pkl')
df_feat = pd.read_pickle(r'manual_resnet_features_dataset.pkl')
df_feat.columns
...
#save model
#dump(model, r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\heuristic_resnet_rf.joblib') 
#model= load( r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\heuristic_resnet_rf.joblib') 
...
len(false)
#np.save(r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\resnet_heur_false_id.npy', false)
...
best_grid= load( r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\resnet_rf.joblib') 
...
#save model
#dump(best_grid, r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\resnet_rf.joblib') 
...
#sel
# resnet freeze:
#array([  15,   10,   12, 1163,   21,    5,  109,   24,   14, 1644,    6,     39,   16,  446])
sel=[  15,   10,   12, 1163,   21,    5,  109,   24,   14, 1644,    6,     39,   16,  446]
df_train_sel=df_train.copy()
df_train_sel= df_train_sel.iloc[:,sel]
df_train_sel
...
#best_grid= load( r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\resnet_heuristic_rf_sel.joblib') 
best_grid= load( r'resnet_heuristic_rf_sel.joblib') 

y_pred = best_grid.predict(df_test_sel)
...
#dump(best_grid, r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\resnet_heuristic_rf_sel.joblib') 
#best_grid= load( r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\resnet_heuristic_rf_sel.joblib') 
#dump(best_grid, r'resnet_heuristic_rf_sel.joblib') 
...
for f in range(0,11):
    print("%d. feature %d (%f)" % (f + 1, indices[f], importances[indices[f]]))
    print(df_test_sel.columns[indices[f]])
...
model_perc= load(r'E:\Babette\MasterThesis\Feature_extractor\ResNet_imagenet\rf_classifier\resnet_heurisic_rf_sel_perc.joblib')
y_pred = best_grid.predict(df_test_sel)
