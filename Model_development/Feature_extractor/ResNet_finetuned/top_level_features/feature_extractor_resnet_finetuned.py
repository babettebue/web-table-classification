...
model5=Sequential()
for layers in funcmodel.layers[2:-1]:
    model5.add(layers)
model5.build(input_shape=(None,224,224,3))
model5.summary()
model5.save('resnet_finetuned_weights_feature_extractor.h5')
...
df_full.to_pickle(r'manual_resnet_finetuned_features_dataset.pkl', protocol=4)
