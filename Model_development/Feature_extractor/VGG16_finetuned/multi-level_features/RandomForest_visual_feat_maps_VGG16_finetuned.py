...
df_feat = pd.read_pickle(r'E:\Babette\MasterThesis\Feature_extractor\VGG16_finetuned\All_feature_maps\manual_vgg16_finetuned_feature_maps_dataset.pkl')
#df_feat = pd.read_pickle(r'manual_vgg16_finetuned_feature_maps_dataset.pkl')
df_feat.columns
...
dump(best_grid, r'heuristic_vgg16_finetuned_feature_maps_rf.joblib', protocol=4) 
...
dump(best_grid_vis, r'vgg16_finetuned_feature_maps_rf.joblib', protocol=4) 
