...
#df_feat = pd.read_pickle(r'E:\Babette\MasterThesis\Feature_extractor\VGG16_imagenet\All_feature_maps\manual_vgg16_feature_maps_dataset.pkl')
df_feat = pd.read_pickle(r'manual_vgg16_feature_maps_dataset.pkl')
df_feat.columns
...
#dump(best_grid, r'heuristic_vgg16_feature_maps_rf.joblib', protocol=4) 
...
df.to_pickle(r'man_vis_rf.pkl', protocol=3)
...
for f in range(10):
    ...
    print(df_test.columns[indices[f]])
...
len(false)
np.save(r'vgg16_maps_heur_false_id.npy', false)
...
#save model
dump(best_grid_vis, r'vgg16_feature_maps_rf.joblib', protocol=4) 
